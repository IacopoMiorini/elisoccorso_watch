"""Mock test: simula un decollo senza toccare OpenSky.

Uso (dalla root del repo):
    TELEGRAM_BOT_TOKEN=... TELEGRAM_CHAT_ID=... .venv/bin/python scripts/mock_test.py

Invia la notifica al `TELEGRAM_CHAT_ID` configurato (tipicamente il canale).
Non tocca lo storage né i subscriber del bot — è solo uno smoke test del
formato del messaggio. Per testare la broadcast completa (canale +
...
from detector import load_helicopters, simulate_flight  # noqa: E402
